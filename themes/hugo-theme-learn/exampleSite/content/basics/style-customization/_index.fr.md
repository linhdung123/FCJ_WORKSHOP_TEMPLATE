...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/FCJ_WORKSHOP_TEMPLATE/images/` et nommez le `favicon.png`
...
```html
<link rel="shortcut icon" href="/FCJ_WORKSHOP_TEMPLATE/images/favicon.png" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/FCJ_WORKSHOP_TEMPLATE/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/FCJ_WORKSHOP_TEMPLATE/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/FCJ_WORKSHOP_TEMPLATE/images/green-variant.png?width=60pc)
