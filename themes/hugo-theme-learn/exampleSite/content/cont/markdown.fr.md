...
La seule différence porte sur la personalisation des /FCJ_WORKSHOP_TEMPLATE/images ([taille]({{< relref "#resizing-image" >}}), [ajout de classes CSS]({{< relref "#add-css-classes" >}})...)
