...
If your favicon is a png, just drop off your image in your local `staticimages/` folder and name it `favicon.png`
...
![Red variant](/en/basics/style-customizationimages/red-variant.png?width=60pc)
...
![Blue variant](/en/basics/style-customizationimages/blue-variant.png?width=60pc)
...
![Green variant](/en/basics/style-customizationimages/green-variant.png?width=60pc)
