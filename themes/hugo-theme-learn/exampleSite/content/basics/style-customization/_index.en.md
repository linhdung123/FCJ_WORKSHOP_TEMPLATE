...
If your favicon is a png, just drop off your image in your local `static/FCJ_WORKSHOP_TEMPLATE/images/` folder and name it `favicon.png`
...
![Red variant](/en/basics/style-customization/FCJ_WORKSHOP_TEMPLATE/images/red-variant.png?width=60pc)
...
![Blue variant](/en/basics/style-customization/FCJ_WORKSHOP_TEMPLATE/images/blue-variant.png?width=60pc)
...
![Green variant](/en/basics/style-customization/FCJ_WORKSHOP_TEMPLATE/images/green-variant.png?width=60pc)
