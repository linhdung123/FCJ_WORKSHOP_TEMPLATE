...
- **Service details**
  ...
  ![ECS](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.3-ecr-task/ECS.png) 

  ![ECS](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.3-ecr-task/ECS1.png)
