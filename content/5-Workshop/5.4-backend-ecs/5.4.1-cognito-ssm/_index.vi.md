...
![Create User Pool](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito0.png)
...
![Cognito Step 1](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito1.png)

![Cognito Step 2](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito2.png)
...
![Cognito Setup Resources 1](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito3.png)

![Cognito Setup Resources 2](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito4.png)
...
![Cognito Setup Resources 2](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito5.png)

click vào App Client của bạn -> **Edit**:

![Cognito Setup Resources 2](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito6.png)

- Ở mục **Auth flows**, đảm bảo đã chọn đủ 3 quyền: `ALLOW_USER_PASSWORD_AUTH`, `ALLOW_REFRESH_TOKEN_AUTH`, `ALLOW_USER_SRP_AUTH`.


![Cognito Setup Resources 2](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/Cognito7.png)
...
![Cognito Setup Resources 2](/FCJ_WORKSHOP_TEMPLATE/images/5-Workshop/5.4-backend-ecs/5.4.1-cognito-ssm/SSM.png)
